    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">[Bhavya]</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">[Bhavya]'s</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>A little countdown for you namuni jhalli</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">✨Be Your Best — [Gautam] ✨</h2>
          <p className="final-subtitle">Pothaaaaaa ✨</p>
        </section>
      </div>
